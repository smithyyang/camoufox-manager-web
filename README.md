...
- Automatic DNS leak prevention (converts `socks5 → socks5h`)
...
Open in your browser: [http://127.0.0.1:7070](http://127.0.0.1:7070)

---

## ⚠️ Notes

- Local access only (`127.0.0.1`) — not exposed to the network by default
- Use separate proxies per profile for proper isolation
